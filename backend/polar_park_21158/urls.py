"""polar_park_21158 URL Configuration
...
admin.site.site_header = "Polar Park"
admin.site.site_title = "Polar Park Admin Portal"
admin.site.index_title = "Polar Park Admin"

# swagger
api_info = openapi.Info(
    title="Polar Park API",
    default_version="v1",
    description="API documentation for Polar Park App",
)
